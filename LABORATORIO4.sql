...
SELECT
	...
	pg_size_pretty(pg_relation_size('ventas_sin_particion')) as tamaño_tabla,
...
-- Paso 3.2: Crear indices en particiones
...
CREATE TABLE ventas_2024_he PARTITION OF ventas_2024_base
...
-- PARTE 6: MANTENIMIENTO AUTOMATIZADO (30 minutos)
...
BEGIN
	...
	nombre_particion := tabla_principal || '_' || año || '_' || LPAD (mes::TEXT, 2, '0');
...
BEGIN
	...
	FOR rec IN
		SELECT tablename
		FROM pg_tables
		WHERE tablename LIKE tabla_principal || '%'
